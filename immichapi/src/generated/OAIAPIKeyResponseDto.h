...
/*
 * OAIAPIKeyResponseDto.h
 *
 * 
 */

#ifndef OAIAPIKeyResponseDto_H
#define OAIAPIKeyResponseDto_H
...
class OAIAPIKeyResponseDto : public OAIObject {
public:
    OAIAPIKeyResponseDto();
    OAIAPIKeyResponseDto(QString json);
    ~OAIAPIKeyResponseDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAPIKeyResponseDto)

#endif // OAIAPIKeyResponseDto_H
