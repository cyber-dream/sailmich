...
#ifndef OAICLIPConfig_H
#define OAICLIPConfig_H
...
class OAICLIPConfig : public OAIObject {
public:
    OAICLIPConfig();
    OAICLIPConfig(QString json);
    ~OAICLIPConfig() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAICLIPConfig)

#endif // OAICLIPConfig_H
