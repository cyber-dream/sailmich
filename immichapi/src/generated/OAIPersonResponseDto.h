...
/*
 * OAIPersonResponseDto.h
 *
 * 
 */

#ifndef OAIPersonResponseDto_H
#define OAIPersonResponseDto_H
...
class OAIPersonResponseDto : public OAIObject {
public:
    OAIPersonResponseDto();
    OAIPersonResponseDto(QString json);
    ~OAIPersonResponseDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPersonResponseDto)

#endif // OAIPersonResponseDto_H
