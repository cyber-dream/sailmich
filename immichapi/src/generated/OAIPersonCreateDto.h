...
/*
 * OAIPersonCreateDto.h
 *
 * 
 */

#ifndef OAIPersonCreateDto_H
#define OAIPersonCreateDto_H
...
class OAIPersonCreateDto : public OAIObject {
public:
    OAIPersonCreateDto();
    OAIPersonCreateDto(QString json);
    ~OAIPersonCreateDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPersonCreateDto)

#endif // OAIPersonCreateDto_H
