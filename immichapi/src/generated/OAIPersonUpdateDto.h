...
/*
 * OAIPersonUpdateDto.h
 *
 * 
 */

#ifndef OAIPersonUpdateDto_H
#define OAIPersonUpdateDto_H
...
class OAIPersonUpdateDto : public OAIObject {
public:
    OAIPersonUpdateDto();
    OAIPersonUpdateDto(QString json);
    ~OAIPersonUpdateDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIPersonUpdateDto)

#endif // OAIPersonUpdateDto_H
