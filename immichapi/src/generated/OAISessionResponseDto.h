...
/*
 * OAISessionResponseDto.h
 *
 * 
 */

#ifndef OAISessionResponseDto_H
#define OAISessionResponseDto_H
...
class OAISessionResponseDto : public OAIObject {
public:
    OAISessionResponseDto();
    OAISessionResponseDto(QString json);
    ~OAISessionResponseDto() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISessionResponseDto)

#endif // OAISessionResponseDto_H
